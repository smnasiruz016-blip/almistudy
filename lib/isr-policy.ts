...
export const BOUNDED_ON_DEMAND: BoundedRoute[] = [
  {
    ...
    approxPages: 29062,
    reason:
      "29,062 university x subject-TAUGHT pairs — finite, derived from in-repo JSON via " +
      ...
      "deployment fail, so these render on first request instead: ~29,062 ISR writes per " +
      ...
      "Counted 2026-08-08 against 6,138 universities (was 23,902 at 4,277): 4.74 taught " +
      "pairs per university, so the 50,000 ceiling arrives at roughly 10,500 universities. " +
