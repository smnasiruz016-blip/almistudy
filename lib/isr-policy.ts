...
export const BOUNDED_ON_DEMAND: BoundedRoute[] = [
  {
    ...
    approxPages: 32872,
    reason:
      "32,872 university x subject-TAUGHT pairs — finite, derived from in-repo JSON via " +
      ...
      "deployment fail, so these render on first request instead: ~32,872 ISR writes per " +
      ...
      "Counted 2026-08-08 against 7,087 universities (was 23,902 at 4,277): 4.64 taught " +
