...
export const BOUNDED_ON_DEMAND: BoundedRoute[] = [
  {
    ...
    approxPages: 34109,
    reason:
      "34,109 university x subject-TAUGHT pairs — finite, derived from in-repo JSON via " +
      ...
      "deployment fail, so these render on first request instead: ~34,109 ISR writes per " +
      ...
      "Counted 2026-08-09 against 7,510 universities (was 23,902 at 4,277): 4.54 taught " +
