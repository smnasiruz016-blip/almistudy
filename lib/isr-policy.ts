...
export const BOUNDED_ON_DEMAND: BoundedRoute[] = [
  {
    ...
    approxPages: 20428,
    reason:
      "20,428 university x subject-TAUGHT pairs — finite, derived from in-repo JSON via " +
      ...
      "deployment fail, so these render on first request instead: ~20,428 ISR writes per " +
