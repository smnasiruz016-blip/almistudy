...
export const BOUNDED_ON_DEMAND: BoundedRoute[] = [
  {
    ...
    approxPages: 33342,
    reason:
      "33,342 university x subject-TAUGHT pairs — finite, derived from in-repo JSON via " +
      ...
      "deployment fail, so these render on first request instead: ~33,342 ISR writes per " +
      ...
      "Counted 2026-08-09 against 7,233 universities (was 23,902 at 4,277): 4.61 taught " +
      "pairs per university, so the 50,000 ceiling arrives at roughly 10,800 universities. " +
